    ...
    public class Updater : ModuleUpdater {
        ...
        private ExtendedSecurityRole CreateUserRole() {
            ...
            if (userRole == null) {
                ...
                userRole.SetTypePermissions<Task>(SecurityOperations.FullAccess, true, false);
                userRole.SetTypePermissions<Employee>(SecurityOperations.ReadOnlyAccess, true, false);
