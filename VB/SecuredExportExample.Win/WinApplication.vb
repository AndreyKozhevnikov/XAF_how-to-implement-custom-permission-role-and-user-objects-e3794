...
Namespace SecuredExportExample.Win
    Partial Public Class SecuredExportExampleWindowsFormsApplication
        ...
        End Sub
        Private Sub SecuredExportExampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
        End Sub
    End Class
