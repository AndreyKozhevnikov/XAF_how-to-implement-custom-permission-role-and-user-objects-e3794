    ...
    Public Class Updater
        ...
        Private Function CreateUserRole() As ExtendedSecurityRole
            ...
            If userRole Is Nothing Then
                ...
                userRole.SetTypePermissions(Of Task)(SecurityOperations.FullAccess, True, False)
                userRole.SetTypePermissions(Of Employee)(SecurityOperations.ReadOnlyAccess, True, False)
