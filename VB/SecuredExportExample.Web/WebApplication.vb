...
Namespace SecuredExportExample.Web
    Partial Public Class SecuredExportExampleAspNetApplication
        ...
        End Sub
        Private Sub SecuredExportExampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
        End Sub
...
'            Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.SecuredExportExampleAspNetApplication_DatabaseVersionMismatch)
