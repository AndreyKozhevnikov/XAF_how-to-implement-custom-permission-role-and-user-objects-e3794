...
#End If
		...
		Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
			...
			AddHandler (CType(WebApplication.Instance.Security, SecurityStrategy)).CustomizeRequestProcessors, Function(s, args) AnonymousMethod1(s, args)
			WebApplication.Instance.Setup()
			WebApplication.Instance.Start()
		End Sub
		
		Private Function AnonymousMethod1(ByVal s As Object, ByVal args As CustomizeRequestProcessorsEventArgs) As Boolean
