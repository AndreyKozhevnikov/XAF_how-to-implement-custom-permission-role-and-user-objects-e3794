...
#End If
        ...
        Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
            ...
            AddHandler CType(WebApplication.Instance.Security, SecurityStrategy).CustomizeRequestProcessors, AddressOf AnonymousMethod1
            WebApplication.Instance.Setup()
            WebApplication.Instance.Start()
        End Sub
        
        Private Sub AnonymousMethod1(ByVal sender2 As Object, ByVal e2 As CustomizeRequestProcessorsEventArgs)
